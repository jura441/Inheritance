...
namespace Geometry
{
	...
	//	~EquilateralTriangle() {}
	//	
	//	double get_height()const {return sqrt(3) / 2 * side;}
	//	double get_area()const {return get_height() * side / 2;}
	//	double get_perimeter()const	{return side * 3;}
...
void main()
{
	...
	Geometry::IsoscalesTriangle itri1(100, 150, 200, 200, 5, Geometry::Color::red);
	itri1.info();
	
	Geometry::IsoscalesTriangle itri2(200, 400, 300, 200, 5, Geometry::Color::blue);
	itri2.info();
